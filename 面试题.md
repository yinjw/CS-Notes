...
* 请写出5种常见到的runtime exception（NullPointerException：空指针异常，IndexOutOfBoundsException：下标越界异常，ClassCastException：类型转换异常，NumberFormatException：数字格式异常，IllegalArgumentException：参数不合法异常）
